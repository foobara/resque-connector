...
into a gem. Put your Ruby code in the file `lib/foobara/resque_connector`. To experiment with that code,
...
To install foobara for now to run tests, you must run the following:
